...
var encode = function (string, quote_style, type)
{
    if (!string)
    {
        return string;
    ...
    if (false === (histogram = get_html_translation_table(type, quote_style)))
    {
        return false;
    }
...
{
    return encode(string, quote_style, 'HTML_SPECIALCHARS');
};

var htmlentities = function (string, quote_style)
{
    return encode(string, quote_style, 'HTML_ENTITIES');
};
